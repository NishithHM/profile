                    ...
                    <div className='aboutme-description'>
                        <div className='aboutme-content'>
                            ...
                            <p className='aboutme-about'>
                               Having <strong>4 years</strong> of experience in Front End Development using <strong>React, React-Native, Javascript, HTML, CSS, Bootstrap, SASS and other recent technologies </strong>
                            ...
                            <div className='aboutme-resume' onClick={()=>document.getElementById('resumeLink').click()}>
                                <a id='resumeLink' className='aboutme-resume-link' href='https://drive.google.com/file/d/1s7WEQoF8MnmACSQvwsims0-dGsh04078/view?usp=sharing' target='_blank'>Download Resume</a>
                            </div>
                        </div>
                    </div>
